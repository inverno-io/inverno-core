...
import io.winterframework.test.WinterModuleException;
 ...
 *
 */
public class TestAutowire extends AbstractCoreWinterTest {

	private static final String MODULE = "io.winterframework.test.autowire";
