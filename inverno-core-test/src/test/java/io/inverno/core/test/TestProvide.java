 ...
 *
 */
public class TestProvide extends AbstractCoreInvernoTest {

	private static final String MODULEA = "io.inverno.core.test.provide.moduleA";
	private static final String MODULEB = "io.inverno.core.test.provide.moduleB";
	private static final String MODULEC = "io.inverno.core.test.provide.moduleC";
	
	@Test
	public void testProvideInternalWiring() throws IOException, InvernoCompilationException, IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
	...
	@Test
	public void testProvideExternalWiring() throws IOException, InvernoCompilationException, IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
	...
	public void testProvideMultipleError() throws IOException {
		try {
			...
			String multipleProvideError = "Bean io.inverno.core.test.provide.moduleC:beanA can't provide multiple types";
