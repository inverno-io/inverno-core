 ...
 *
 */
public class TestSocketBean extends AbstractCoreInvernoTest {

	private static final String MODULEA = "io.inverno.core.test.socketbean.moduleA";
	private static final String MODULED = "io.inverno.core.test.socketbean.moduleD";
	...
	public void init() throws IOException, InvernoCompilationException {
		if(this.moduleProxyBuilder == null) {
			this.moduleProxyBuilder = this.getInvernoCompiler().compile(MODULEA).load(MODULEA);
		}
	...
	@SuppressWarnings("unchecked")
	@Test
	public void testSockets() throws IOException, InvernoCompilationException, IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
		this.init();
		
		InvernoModuleProxy moduleProxy = this.moduleProxyBuilder
	...
	@Test
	public void testNullRequiredSocket() throws IOException, InvernoCompilationException {
		this.init();
	...
	@Test
	public void testNullOptionalSocket() throws IOException, InvernoCompilationException, IllegalArgumentException, IllegalAccessException, NoSuchFieldException, SecurityException {
		this.init();
	...
	@Test
	public void testIgnoreUnwired() throws IOException, InvernoCompilationException {
