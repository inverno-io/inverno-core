 ...
 *
 */
public class InvernoModuleProxyBuilder {
	...
	public InvernoModuleProxyBuilder(String moduleName, Class<?> moduleBuilderClass) {
	...
	public InvernoModuleProxyBuilder dependencies(Object... values) {
	...
	public InvernoModuleProxyBuilder optionalDependency(String name, Object value) {
	...
	public InvernoModuleProxyBuilder optionalDependency(String name, Class<?> dependencyType, Object value) throws InvernoModuleException {
		Method depSetter;
		try {
	...
	public InvernoModuleProxy build() throws InvernoModuleException {
		...
		try {
			return new InvernoModuleProxy(this.moduleBuilderClass.getMethod("build").invoke(moduleBuilder));
		} 
		catch (InvocationTargetException e) {
			throw new InvernoModuleException(e.getCause());
		}
