...
You can then build the module with Maven:

    > mvn install

During the build, the Winter compiler generates a module class named after the module, `io.winterframework.example.hello.Hello` in our example. This class contains all the logic required to instantiate and wire your beans at runtime. 
...
Now just rebuild the project and run the application:
